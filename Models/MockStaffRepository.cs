...
public class MockStaffRepository : IStaffRepository // subklass till Istaffrepository
{
    ...
    new List<Staff>
    {
        ...
        new Staff { StaffId=3, Name="Åke", Admin=false, Age=59, Email="Åkesson@gmail.com", Bio="ke är vår specialist på målning och finishing. Han ger varje tomte sin egen personlighet och charm genom sitt konstnärliga arbete. \n Hans färgval och detaljer gör varje figur till något speciellt." }
    };
